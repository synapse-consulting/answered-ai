                    ...
                    <div>
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="flex items-center justify-between">
                                        ...
                                        <label for="checkboxLabelOne"
                                            ...
                                            <div class="relative">
                                                ...
                                                <div :class="checkboxToggle ? 'border-brand-500 bg-brand-500' :
                                                    ...
                                                    class="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] bg-transparent border-gray-300 dark:border-gray-700">
                                    ...
                                    <a href="{{ route('password.request') }}"
                                        class="text-sm text-gray-800 hover:text-brand-600 dark:text-brand-400">Forgot
                                        password?</a>
                                </div>
                                <!-- Button -->
                                <div>
                        ...
                        <div class="mt-5">
                            <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                                ...
                                <a href="{{ route('register') }}" class="text-gray-800 hover:text-brand-600 dark:text-brand-400">Sign
                                    Up</a>
                            </p>
                        </div>
                    </div>
