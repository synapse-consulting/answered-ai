...
type Props = HandleProps & {
  nodeProps: NodeProps<Node<BaseNodeData<Record<string, unknown>>, NodeTypes>>;
};
  ...
  return (
    <Handle
      ...
      style={{
        ...
        height: "10px",
        border: "2px solid",
        borderColor: dimColor(props.nodeProps.data.view.color ?? "#000", 1),
        background: dimColor(props.nodeProps.data.view.color ?? "#000", 0.3),
        ...props.style,
      }}
    />
  );
